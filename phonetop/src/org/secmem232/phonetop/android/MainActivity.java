...
/**
 * 메인화면 Activity : 클라이언트 연결 옵션 설정. 연결 유/무 조작 관련  UI.
 * @author youngsick
 *
 */
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//체크박스 상태에 따라서 마우스기능 활성/비활성화를 설정.
		...
		//체크박스 상태에 따라서 키보드기능 활성/비활성화를 설정.
		...
		//체크박스 상태에 따라서 모니터기능 활성/비활성화를 설정.
		...
		//체크박스 상태에 따라서 테더링기능 활성/비활성화를 설정.
	...
	/**
	 * 메세지 핸들러에 값을 보내서 해당 what의 값이 따라 맡은 역할 수행.
	 * @param what 메세지 flag변수 
	 */
